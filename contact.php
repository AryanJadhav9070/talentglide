...
<main>
  ...
  <section class="py-28 relative">
     <div class="text-center mb-12">
            <h3 class="text-gray-1000 font-bold dark:text-white text-3xl mb-2">
             Contact us
            </h3>
            <p class="text-gray-500 dark:text-gray-400">
              We have our presence in USA, Canada & India
            </p>
          </div>
    <div class="wrapper">
  ...
  <div class="h-full hidden lg:block">
    <div class="h-full rounded-2xl overflow-hidden shadow-theme-xs border border-gray-300 dark:border-gray-700">
      <img 
        src="assets/images/globalpres.webp" 
        alt="Location Image"
        width="100%"
        height="100%"
        class="min-h-[500px] object-cover w-full"
      >
    </div>
  </div>
  
  <!-- Google Map Section (Right) - Hidden on mobile -->
  <div class="h-full hidden lg:block">
    <div class="h-full rounded-2xl overflow-hidden shadow-theme-xs border border-gray-300 dark:border-gray-700">
      <iframe 
